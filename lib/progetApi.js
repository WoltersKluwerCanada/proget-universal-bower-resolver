...
class ProgetApi {
    ...
    getPackagesSingle(url, pkg) {
        return this.sendRequest(url, pkg, "ProGetPackages_GetPackages").then((response) => {
            try {
    ...
    getPackageVersions(pkg) {
        if (ProgetApi.isShortFormat(pkg)) {
            ...
            return this.sendRequest(pkg, null, "ProGetPackages_GetPackageVersions").then((response) => {
...
//# sourceMappingURL=progetApi.js.map